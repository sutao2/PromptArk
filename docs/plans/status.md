...
|---|---|
| 状态 | 现行（活文档，只写今天为真的事） |
| 更新日期 | 2026-08-23（M7 已关闭；下一步 M8 设置对齐） |
...
| M8 设置对齐 | 计划中 | [2026-08-23-m8-settings-ia.md](2026-08-23-m8-settings-ia.md)；可开始应用实现 |

## 当前可执行的下一步

1. M7 已关闭。按 [M8 计划](2026-08-23-m8-settings-ia.md) 对齐设置弹窗；不得删除已有本机设置行为。
