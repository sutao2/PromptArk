...
|---|---|
| 状态 | 现行（活文档，只写今天为真的事） |
| 更新日期 | 2026-08-24（M8 已关闭；正在配 Windows NSIS，不声称已验证） |
...
1. M8 已关闭。没有 M9。当前切片：[Windows NSIS](2026-08-24-windows-nsis.md)。本机是 macOS，打不出 Windows 安装包；不得宣传 Windows 已支持。OAuth、云同步、商店上架不得假装接通。
