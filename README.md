...
M0–M8 已关闭。本机工作台、独立启动器、库文件备份、设置十类、本仓库广场 API、独立管理台、已登录收藏、令牌轮换与管理员身份读取可用。已验证平台是 macOS，未验证 Windows / Linux。无商店包、无公开下载声明。云同步、OAuth、自动更新安装不得假装接通。
