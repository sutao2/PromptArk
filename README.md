...
M0–M6 已关闭。本机工作台、独立启动器、库文件备份、本仓库广场 API 与独立管理台可用。已验证平台是 macOS，未验证 Windows / Linux。无商店包、无公开下载声明。M7 计划与规格场景已写，提案仍是草稿；未接受前不实现收藏写路径、令牌轮换或 `GET /v1/admin/me`。
